...
public class Medicine {
	...
	@ManyToMany
	@JsonBackReference(value = "Medicamento-Episodio")
	@JoinTable(name = "MedicamentoPorEpisodio", 
		joinColumns = @JoinColumn(name = "idMedicamento", referencedColumnName = "id"), 
		inverseJoinColumns = @JoinColumn(name = "idEpisodio", referencedColumnName = "id"))
	private Set<Episode> episode = new HashSet<Episode>();

	 @ManyToMany
	 @JsonBackReference(value = "Medicamento-Diagnostico")
